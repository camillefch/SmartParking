...
public class GeneralCountDeviceUtility  {
    ...
    public static void susbcribe(String topic, String URL) throws MqttException {
...
class MqttCallBackGeneralCount implements MqttCallback {
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        ...
        int nbavailablespots = p3.getNbSpots()- Integer.parseInt(message.getPayload().toString());
